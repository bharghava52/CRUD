...
public class ConnectionPooling {
    ...
    public static ConnectionPooling getInstance(String driver,String url, String username, String password,int no_of_conn) throws ClassNotFoundException, SQLException{
        if(Cpobj == null){
            ...
            ConnectionPooling.no_of_conn= no_of_conn;
